...
//      [N,N],
//  ]
let startTube = [[G, K], [B, R], [R, G], [K, B], [N, N]]
// 上段　下段（試験管の座標）
let tubePos = [[[17, 2, 15], [17, 1, 15]], [[17, 2, 17], [17, 1, 17]], [[17, 2, 19], [17, 1, 19]], [[17, 2, 21], [17, 1, 21]], [[17, 2, 23], [17, 1, 23]]]
// カーソルの座標
let cursorPos = [[18, 3, 15], [18, 3, 17], [18, 3, 19], [18, 3, 21], [18, 3, 23]]
// ボタン入力検出用座標
let selectPosList = [[19, -2, 21], [19, -2, 17], [19, -2, 19]]
// L
// R
// Ac
let tube = startTube
